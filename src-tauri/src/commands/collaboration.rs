...
pub async fn get_shared_document(
    ...
    let shared_doc = collaboration_ops::get_shared_document_by_token(&pool, &token)
        .await
        .map_err(|e| StoryWeaverError::database(e.to_string()))?;
    ...
    if let Some(doc) = &shared_doc {
        ...
        collaboration_ops::increment_share_usage(&pool, doc.id)
            .await
            .map_err(|e| StoryWeaverError::database(e.to_string()))?;
    }
...
pub async fn add_comment(
    ...
    collaboration_ops::create_comment(&pool, request)
        .await
        .map_err(|e| StoryWeaverError::database(e.to_string()))
}
...
pub async fn get_comments(document_id: String) -> Result<Vec<Comment>> {
    ...
    collaboration_ops::get_document_comments(&pool, &document_id)
        .await
        .map_err(|e| StoryWeaverError::database(e.to_string()))
}
...
pub async fn get_comment_threads(document_id: String) -> Result<Vec<CommentThread>> {
    ...
    collaboration_ops::get_comment_threads(&pool, &document_id)
        .await
        .map_err(|e| StoryWeaverError::database(e.to_string()))
}
...
pub async fn resolve_comment(comment_id: i32, resolved_by: String) -> Result<()> {
    ...
    collaboration_ops::resolve_comment(&pool, comment_id, &resolved_by)
        .await
        .map_err(|e| StoryWeaverError::database(e.to_string()))
}
...
pub async fn delete_comment(comment_id: i32) -> Result<()> {
    ...
    collaboration_ops::delete_comment(&pool, comment_id)
        .await
        .map_err(|e| StoryWeaverError::database(e.to_string()))
}
...
pub async fn duplicate_document_for_sharing(
    ...
    collaboration_ops::duplicate_document_for_sharing(&pool, &document_id, &new_title)
        .await
        .map_err(|e| StoryWeaverError::database(e.to_string()))
}
...
pub async fn unpublish_shared_document(share_token: String) -> Result<()> {
    ...
    collaboration_ops::unpublish_shared_document(&pool, &share_token)
        .await
        .map_err(|e| StoryWeaverError::database(e.to_string()))
}
...
pub async fn republish_shared_document(share_token: String) -> Result<()> {
    ...
    collaboration_ops::republish_shared_document(&pool, &share_token)
        .await
        .map_err(|e| StoryWeaverError::database(e.to_string()))
}
...
pub async fn get_project_shared_documents(project_id: String) -> Result<Vec<SharedDocument>> {
    ...
    collaboration_ops::get_project_shared_documents(&pool, &project_id)
        .await
        .map_err(|e| StoryWeaverError::database(e.to_string()))
}
...
pub async fn get_notifications_for_user(
    ...
    collaboration_ops::get_notifications_for_user(&pool, &recipient_token, limit)
        .await
        .map_err(|e| StoryWeaverError::database(e.to_string()))
}
...
pub async fn mark_notification_read(notification_id: i32) -> Result<()> {
    ...
    collaboration_ops::mark_notification_read(&pool, notification_id)
        .await
        .map_err(|e| StoryWeaverError::database(e.to_string()))
}
...
pub async fn mark_all_notifications_read(recipient_token: String) -> Result<()> {
    ...
    collaboration_ops::mark_all_notifications_read(&pool, &recipient_token)
        .await
        .map_err(|e| StoryWeaverError::database(e.to_string()))
}
...
pub async fn get_unread_notification_count(recipient_token: String) -> Result<i32> {
    ...
    collaboration_ops::get_unread_notification_count(&pool, &recipient_token)
        .await
        .map_err(|e| StoryWeaverError::database(e.to_string()))
}
...
pub async fn delete_old_notifications(days_old: i32) -> Result<()> {
    ...
    collaboration_ops::delete_old_notifications(&pool, days_old)
        .await
        .map_err(|e| StoryWeaverError::database(e.to_string()))
}
